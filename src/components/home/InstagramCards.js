        ...
        <div className='w-[300px] shadow-lg'>
                        ...
                        <div className='flex justify-between items-center w-full bg-white p-2'>
                            <div className='flex gap-4'>
                                <img src={foodielandLogo} alt="instagramProfile"
                                className='object-cover cursor-pointer w-[40px] h-[40px] ' />
                                <div className='leading-4'>
                                    <p className='flex items-center font-semibold gap-2 cursor-pointer'>Foodieland <MdVerified className='text-[#3897F0] ' /></p>
                        ...
                        <div className='flex flex-col bg-white w-full p-3 justify-between'>
                            ...
                            <div>
                                <div className='flex mt-4 gap-2 items-center'>
                                    <img src={instaPhoto} alt="instaPhoto" className='h-5 w-5 cursor-pointer'/>
                                    <p>Liked by <span className='font-semibold cursor-pointer'>craig_love</span> and <span className='font-semibold cursor-pointer'>44,886</span></p>
                                    </div>
                                <div className='mt-2'>
                                    <p><span className='font-semibold cursor-pointer '>Foodieland.</span>{props.title} </p>
                                </div>
