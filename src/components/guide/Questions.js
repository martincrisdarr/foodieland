      ...
      <div className="px-6 md:px-16 inter flex flex-col mt-24 w-full">
        ...
        <div className="flex w-full">
          <div className="w-full md:w-[90%] ">
            ...
            <p className="text-[#00000099] md:pr-48 mt-8">
        ...
        <div className="mt-16 w-full md:w-[90%]">
          ...
          <p className="text-[#00000099] md:pr-52 mt-8">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur
            ac ultrices odio. Nulla at congue diam, at dignissim turpis. Ut
            vehicula sed velit a faucibus. In feugiat vestibulum velit vel
            pulvinar. Fusce id mollis ex. Praesent feugiat elementum ex ut
        ...
        <h1 className="mt-16 border-b-2 border-t-2 py-16 w-full md:w-[80%] text-2xl md:text-4xl interItalic guideItalicTextBackground font-semibold px-8 ">
          “Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ac
          ultrices odio.”
        </h1>
        <div>
          <h1 className="font-semibold text-2xl md:pr-64 mt-16">
            What is the biggest misconception that people have about being a
            professional chef?
          </h1>
          <p className="text-[#00000099] md:pr-64 mt-8">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur
            ac ultrices odio. Nulla at congue diam, at dignissim turpis. Ut
            vehicula sed velit a faucibus. In feugiat vestibulum velit vel
            pulvinar. Fusce id mollis ex. Praesent feugiat elementum ex ut
