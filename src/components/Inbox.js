  ...
  return (
    <>
      <div className="w-full lg:w-[85%] mt-32 rounded-3xl bg-[#E7F9FD] inter flex flex-col mx-auto items-center justify-center py-12 px-6 md:p-16 gap-8 ">
        ...
        <p className="text-[#00000099] px-8 lg:px-32 text-center ">
        ...
        >
          ...
          ></input>
          <button
            className="h-full py-6 px-6 md:px-12 mt-6 bg-black rounded-xl text-white font-semibold hover:bg-zinc-900"
            type="submit"
          >
            Suscribe
          </button>
